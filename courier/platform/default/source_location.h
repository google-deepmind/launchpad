...
#ifndef COURIER_PLATFORM_DEFAULT_SOURCE_LOCATION_H_
#define COURIER_PLATFORM_DEFAULT_SOURCE_LOCATION_H_
...
#define COURIER_LOC \
  ::courier::internal::source_location::DoNotInvokeDirectly(__LINE__, __FILE__)

#endif  // COURIER_PLATFORM_DEFAULT_SOURCE_LOCATION_H_
